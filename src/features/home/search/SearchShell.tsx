...
const SearchShell = ({
  ...
  const shouldShowPopularKeywords =
  ...
  const shouldShowPopularKeywordsSkeleton =
    shouldReservePopularKeywordsSpace && query.trim().length === 0
        ...
        >
          {onRotatePopularKeywords ? (
            <Button
              ...
              aria-label={refreshPopularSearchLabel || 'Refresh keywords'}
              onClick={() => onRotatePopularKeywords()}
            >
