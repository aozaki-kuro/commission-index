...
describe('ProtectedCommissionImage', () => {
  it('builds responsive srcset variants', () => {
    expect(buildResponsiveSrcSet('/images/sample.webp')).toBe(
      '/images/sample-768.webp 768w, /images/sample-960.webp 960w, /images/sample-1280.webp 1280w',
    )
    expect(buildResponsiveSrcSet('/images/sample.webp?v=1')).toBe(
      '/images/sample-768.webp?v=1 768w, /images/sample-960.webp?v=1 960w, /images/sample-1280.webp?v=1 1280w',
    )
  ...
  it('renders priority image with eager loading and high fetchpriority', () => {
    render(
      <ProtectedCommissionImage
        altText="sample alt"
        resolvedImageSrc="/images/sample.webp"
        priority
      />,
    )
