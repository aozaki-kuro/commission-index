...
export const dedupeKeywords = (keywords: Iterable<string>, maxCount = Number.POSITIVE_INFINITY) => {
...
export const buildPopularKeywordPoolFromSuggestTexts = (
  suggestTexts: Iterable<string>,
  maxKeywords = DEFAULT_MAX_POPULAR_KEYWORDS,
) => {
